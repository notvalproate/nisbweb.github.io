!(function (e) {
    ...
    30: function (e, t, n) {
        ...
        var E,
            L = new ((g = Object(f.a)({ x: 1, y: 1 }, 0.1)),
            Object(l.a)(
                ((E = j =
                    g(
                        (j = (function (e) {
        ...
        var A = new o.Vector3(),
            ...
            J = new o.MeshBasicMaterial({ wireframe: !0, visible: !1 }),
            V = new o.Mesh(D, J);
                    ...
                    (o = [
                        {
                            ...
                            value: function () {
                                for (var e = Object(u.a)(-2.4, 7.2), n = (-25 * Math.PI) / 180, o = (200 * Math.PI) / 180, r = []; n < o; ) {
                                    (n += 0.2), (e -= 0.1), A.set(4 * Math.cos(n), e, 4 * Math.sin(n)), B.set(-A.x, 0, -A.z), B.normalize(), I.set(A, B);
                                    var i = I.intersectObject(V, !0);
                                    i.length && r.push(i[0].point.x, i[0].point.y, i[0].point.z);
                                }
                                0 !== r.length &&
                                    (Math.random() > 0.5
                                        ? _(F(t.prototype), "addLine", this).call(this, { visibleLength: Object(u.a)(0.01, 0.2), points: r, speed: Object(u.a)(0.003, 0.008), color: Object(s.a)(q), width: Object(u.a)(0.01, 0.1) })
                                        : _(F(t.prototype), "addLine", this).call(this, { visibleLength: Object(u.a)(0.05, 0.2), points: r, speed: Object(u.a)(0.01, 0.1), color: q[0], width: Object(u.a)(0.01, 0.01) }));
                            },
                        },
                    ]) && S(n.prototype, o),
                    r && S(n, r),
        ...
        H.to(".overlay", 4, { autoAlpha: 0 }),
            H.fromTo(L.lookAt, 3, { y: -4 }, { y: 0, ease: Power3.easeOut }, "-=2"),
            H.add(C.show, "-=2"),
            P.a.onHide(function (e) {
                var t = new TimelineLite();
                t.to(L.lookAt, 2, { y: -6, ease: Power3.easeInOut }), t.add(C.hide, 0), t.add(G.stop), t.to(".overlay", 0.5, { autoAlpha: 1, onComplete: e }, "-=1.5");
            });
    },
});
